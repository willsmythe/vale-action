...
exports.toAnnotationProperties = exports.CheckRunner = void 0;
 ...
 */
class CheckRunner {
    constructor(modified, output, onlyAnnotateModifiedLines = false) {
        this.annotations = [];
        this.stats = {
            suggestions: 0,
            warnings: 0,
    ...
    makeAnnotations(output) {
        ...
        for (const filename of Object.getOwnPropertyNames(alerts)) {
            for (const alert of alerts[filename]) {
                if (this.onlyAnnotateModifiedLines &&
    ...
    runUpdateCheck(client, checkRunId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (annotations.length > 0) {
                ...
                const response = yield client.rest.checks.update(req);
     ...
     */
    static makeAnnotation(filename, alert) {
...
function toAnnotationProperties(annotation) {
    return {
